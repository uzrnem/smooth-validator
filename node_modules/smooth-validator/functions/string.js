...
module.exports = {
  ...
  validateStartsNotWith: function (varName, varValue, values) {
    for ( var c in values) {
      if (varValue.startsWith(values[c])) {
        return { resKey: varName, resMsg: ' does starts with ' + values[c] };
      }
    }
    return { resKey: false, resMsg: null };
  },
  ...
  validateEndsNotWith: function (varName, varValue, values) {
    for ( var c in values) {
      if (varValue.endsWith(values[c])) {
        return { resKey: varName, resMsg: ' does ends with \'' + values[c] + '\'' };
      }
    }
    return { resKey: false, resMsg: null };
  },
  validateContains: function (varName, varValue, values) {
    for ( var c in values) {
      if (!varValue.includes(values[c])) {
        return { resKey: varName, resMsg: ' does not contains \'' + values[c] + '\'' };
      }
    }
    return { resKey: false, resMsg: null };
  },
  validateContainsAny: function (varName, varValue, values) {
    ...
    return { resKey: varName, resMsg: ' does not contains any of ' + values };
  }
}