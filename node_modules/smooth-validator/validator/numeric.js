...
module.exports = {
  validateNumeric: function (varName, varValue) {
    return dataType.isNumber(varValue) ? null : { variable: varName, name: varName, value: varValue, first_value: varValue };
  },
  validateBetween: function (varName, varValue, values, dataObj) {
    ...
    return (varValue < min || varValue > max) ? { variable: varName, name: varName, value: varValue, first_value: values[0], second_value: values[1] } : null;
  },
  validateGt: function (varName, varValue, values, dataObj) {
    var c = values[0]
    if (values[0] in dataObj) { c = dataObj[values[0]]}
    return (varValue <= c) ? { variable: varName, name: varName, value: varValue, first_value: values[0] } : null;
  },
  ...
  validateOdd: function (varName, varValue) {
    return ((varValue % 2) == 1) ? null : { variable: varName, name: varName, value: varValue, first_value: varValue };
  },
  validateEven: function (varName, varValue) {
    return ((varValue % 2) == 0) ? null : { variable: varName, name: varName, value: varValue, first_value: varValue };
  }
}